    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="widget">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo $config->link1; ?>">Shahroodut</a></li>
                        <li><a href="<?php echo $config->link2; ?>">Isfahan University</a></li>
                        <li><a href="<?php echo $config->link3; ?>">Shahrood University of Technology</a></li>
                    </ul>
                </div>
            </div>
            <!-- break -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="widget">
                    ...
                    <address>
                        <strong><?php echo $config->details; ?></strong><br>
                        <br>
                        <br>
                        تلفن : <?php echo $config->phone; ?><br>
                         فکس : <?php echo $config->fax; ?><br>
                       ایمیل : <?php echo $config->email; ?>
                    </address>
                </div>
            </div>
            <!-- break -->
        ...
        <div class="row">
            <div class="col-md-12 copyleft">
                <p>کلیه حقوق مادی و معنوی برای مجموعه <?php echo $config->title; ?> محفوظ می باشد . هر گونه کپی برداری از محتوا با ذکر منبع مجاز می باشد.</p>

                <a href="#top" class="btn btn-primary scroltop"><i class="fa fa-angle-up"></i></a>
                <ul class="list-inline social-links">
                    <li><a href="https://twitter/<?php echo $config->twitter; ?>" class="icon-twitter" rel="tooltip" title="" data-placement="bottom" data-original-title="Twitter"><i class="fa fa-twitter"></i></a></li>
                    <li><a href="https://facebook.com/<?php echo $config->facebook; ?>" class="icon-facebook" rel="tooltip" title="" data-placement="bottom" data-original-title="Facebook"><i class="fa fa-facebook"></i></a></li>
                    <li><a href="mailto:<?php echo $config->email; ?>" class="icon-g" rel="tooltip" title="" data-placement="bottom" data-original-title="Mail"><i class="fa fa-google-plus"></i></a></li>
                </ul>
            </div>
        </div>
        <!-- end:copyleft -->
                ...
                <form role="form" action="index.php?c=user&a=register" method="post" >
                    ...
                    <div class="checkbox">
                        <label>
                            ...
                            <input type="radio" name="frm[type]" value="designer"> طراح<br>
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
