...
<div class="navbar">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="index.php?c=cp&a=dashboard"><span>Dena</span></a>
                ...
                <ul class="nav pull-left">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="index.php"><i class="halflings-icon user"></i>مشاهده وبسایت</a></li>
                            <li><a href="#"><i class="halflings-icon user"></i>پروفایل</a></li>
                            <li><a href="index.php?c=user&a=logout"><i class="halflings-icon off"></i>خروج</a></li>
                        </ul>
                    </li>
                    <!-- end: User Dropdown -->
                </ul>
