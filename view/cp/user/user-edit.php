...
$html1 = <<<EOF
    ...
    <div class="box span12">
        <div class="box-header" data-original-title>
            <h2><i class="halflings-icon edit"></i><span class="break"></span> ویرایش کاربر : $user->username  </h2>
            <div class="box-icon">
...
<?php } else if ($user->user_type == "householder") { ?>
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <div style="clear:both"></div>
            <label class="radio">
                <input type="radio" name="frm[level]" id="optionsRadios2" value="designer" checked="">
                طراح </label>
        </div>
    </div>
<?php } else { ?>
