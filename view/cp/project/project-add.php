...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header" data-original-title>
            <h2><i class="halflings-icon edit"></i><span class="break"></span>افزودن پروژه جدید</h2>
            <div class="box-icon">
            ...
            <form class="form-horizontal" method="post" action="">
                <fieldset>
                    <div class="control-group success">
                        <label class="control-label" for="inputSuccess">نام طرح یا پروژه</label>
                        <div class="controls">
                    ...
                    <div class="control-group success">
                        ...
                        <div class="controls">
                            <input type="text" id="inputSuccess" name="frm[company]">
                        </div>
                    </div>
                    ...
                    <div class="control-group success">
                        ...
                        <div class="controls">
                            <textarea class="textarea" name="frm[details]"></textarea>
                        </div>
                    </div>
                    <div class="control-group success">
                    ...
                    <div class="control-group success">
                        <label class="control-label" for="inputSuccess">لینک فایل ها</label>
                        <div class="controls">
                            <input type="text" id="inputSuccess" name="frm[file_path]" placeholder="Linking .zip/.rar file">
                        </div>
                    </div>
                    <div class="control-group success">
