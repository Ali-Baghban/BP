            ...
            <div class="col-md-12">
                <div class="blog-container">
                    <div class="blog-content">
                        <div class="blog-image" style="background-image: url(public/default/image/img16.jpg);">
                            <div class="blog-author"><img src="public/default/image/logos.png" alt="Ali Baghban"> Ali Baghban</div>
                        </div>
                        ...
                        <div class="the-team">
                            <div class="row container-realestate">
                                <div class="col-md-4">
                                    <div class="team-container">
                                        <div class="team-image">
                                            <img src="public/default/image/team01.jpg" alt="the team - mikha realestate theme">
                                        </div>
                                        <div class="team-description">
                                            <h3>نگار باغبان <small>مدیر اجرایی</small></h3>
                                ...
                                <div class="col-md-4">
                                    <div class="team-container">
                                        <div class="team-image">
                                            <img src="public/default/image/Ali.jpg" alt="the team - mikha realestate theme">
                                        </div>
                                        <div class="team-description">
                                            <h3>علی باغبان<small>برنامه نویس ارشد</small></h3>
                                            <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی</p>
                                            <div class="team-social">
                                                <span><a href="#" title="Twitter" rel="tooltip" data-placement="top"><i class="fa fa-twitter"></i></a></span>
                                                <span><a href="#" title="Facebook" rel="tooltip" data-placement="top"><i class="fa fa-facebook"></i></a></span>
                                ...
                                <div class="col-md-4">
                                    <div class="team-container">
                                        ...
                                        <div class="team-description">
                                            <h3>مدیحه جوادی  <small>مدیر امور مالی</small></h3>
                                            <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی</p>
                                            <div class="team-social">
                                                <span><a href="#" title="Twitter" rel="tooltip" data-placement="top"><i class="fa fa-twitter"></i></a></span>
                                                <span><a href="#" title="Facebook" rel="tooltip" data-placement="top"><i class="fa fa-facebook"></i></a></span>
